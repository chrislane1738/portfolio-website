...
export default function FavoritesFilterButton({
  ...
  return (
    <button
      ...
      title={active ? 'Show all projects' : 'Show favorite projects only'}
      className={`fixed left-4 md:left-6 top-1/2 -translate-y-1/2 z-30 group flex items-center justify-center w-10 h-10 rounded-sm border transition-all duration-300 ${
        active
